...
int vlc_entry__ugly (int (*)(void *, void *, int, ...), void *);
...
int vlc_entry__trivial (int (*)(void *, void *, int, ...), void *);
...
int vlc_entry__imem_access (int (*)(void *, void *, int, ...), void *);
...
int vlc_entry__adaptative (int (*)(void *, void *, int, ...), void *);
...
const void *vlc_static_modules[] = {
 ...
 vlc_entry__playlist,
 vlc_entry__param_eq,
 vlc_entry__mpegvideo,
 vlc_entry__mpeg4video,
 vlc_entry__mpeg4audio,
 vlc_entry__h264,
 vlc_entry__flac,
 vlc_entry__dirac,
 vlc_entry__copy,
